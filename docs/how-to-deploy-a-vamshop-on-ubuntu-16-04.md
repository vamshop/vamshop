...
-e DB_PORT=27017 \
-e DB_NAME=shop \
-v /var/www/store/content:/var/www/vamshop/public/content \
...
Run `npm run setup` on VamShop container to add default data and create indexes.
...
By default, VamShop is in developer mode. This means you can access API and Dashboard without access tokens.  
To turn off developer mode, you need to do:
 ...
 - `npm run build` inside VamShop container
 - `pm2 reload api` inside VamShop container
